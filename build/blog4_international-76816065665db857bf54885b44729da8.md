...
In [Part 3](blog3_counterfactual.md), we used counterfactual analysis for the United States and explained how we identify **leading factors** for each country.
Here we survey those factors across the OECD, then discuss evidence that public health and safety policies can reduce the life expectancy gap — including road traffic, alcohol, smoking, cancer, suicide, and homicide.
