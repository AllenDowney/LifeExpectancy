...
- [Technical Report](hale_gaps.md) - Analysis of the gender gap in life expectancy and HALE, including methodology, results, and counterfactual analysis.
...
For detailed findings and counterfactual analysis, see the [Technical Report](hale_gaps.md).
