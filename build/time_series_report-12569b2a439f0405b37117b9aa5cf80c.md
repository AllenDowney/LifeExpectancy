# Time Series Analysis: Trends in Health Indicators and Gender Gaps (2000-2023)

## Purpose

This report examines temporal trends in health indicators and gender gaps across OECD countries from 2000 to 2023 (including the COVID-19 period). By analyzing data across all years in this period, we can observe:
...
- **Time Period**: 2000-2023 (includes COVID-19 period 2020-2023)
- **Data Sources**:
  - **HALE (Healthy Life Expectancy)**: IHME Global Burden of Disease 2023 (2000-2023)
  - **Life Expectancy**: Our World in Data (OWID), combining Human Mortality Database and UN World Population Prospects (2000-2023)
  - **Cause-specific mortality indicators**: IHME Global Burden of Disease (cardiovascular disease, diabetes, chronic respiratory disease, neoplasms, alcohol use disorders, self-harm/suicide, interpersonal violence/homicide, road injuries, unintentional injuries, liver disease, COVID-19)

### Data Processing

For each indicator, we:

1. **Load temporal data**: Preserve all years from 2000-2023 (not just the most recent year)
...
- **Mean**: Average value across all years (2000-2023)
...
HALE Over Time (2000-2023) - All OECD Countries
```
...
HALE Over Time (2000-2023) - Selected Countries
```
...
Life Expectancy Over Time (2000-2023) - All OECD Countries
```
...
Life Expectancy Over Time (2000-2023) - Selected Countries
```
...
HALE Gender Gap Over Time (2000-2023) - All OECD Countries
```
...
HALE Gender Gap Over Time (2000-2023) - Selected Countries
```
...
Life Expectancy Gender Gap Over Time (2000-2023) - All OECD Countries
```
...
Life Expectancy Gender Gap Over Time (2000-2023) - Selected Countries
```
...
### Value Changes: 2000 to 2023

The following table shows how HALE values changed for each country over the two-decade period:

```{include} tables/hale_value_changes_2000_2023.html
```

The following table shows how Life Expectancy values changed for each country over the two-decade period:

```{include} tables/le_value_changes_2000_2023.html
```

**Key Findings from Value Changes:**

- **Most countries show increases**: The vast majority of OECD countries have seen their HALE and Life Expectancy increase from 2000 to 2023
...
### Gap Changes: 2000 to 2023

The following table shows how HALE gaps changed for each country over the two-decade period:

```{include} tables/hale_gap_changes_2000_2023.html
```

The following table shows how Life Expectancy gaps changed for each country over the two-decade period:

```{include} tables/le_gap_changes_2000_2023.html
```

**Key Findings from Gap Changes:**

- **Most countries show narrowing gaps**: The majority of OECD countries have seen their gender gaps decrease from 2000 to 2023
...
Alcohol Use Disorders Death Rate Over Time (2000-2023) - All OECD Countries
```
...
Alcohol Use Disorders Death Rate Over Time (2000-2023) - Selected Countries
```
...
Alcohol Use Disorders Gender Gap Over Time (2000-2023) - All OECD Countries
```
...
Alcohol Use Disorders Gender Gap Over Time (2000-2023) - Selected Countries
```
...
Cardiovascular Disease Death Rate Over Time (2000-2023) - All OECD Countries
```
...
Cardiovascular Disease Death Rate Over Time (2000-2023) - Selected Countries
```
...
Cardiovascular Disease Gender Gap Over Time (2000-2023) - All OECD Countries
```
...
Cardiovascular Disease Gender Gap Over Time (2000-2023) - Selected Countries
```
...
Chronic Respiratory Disease Death Rate Over Time (2000-2023) - All OECD Countries
```
...
Chronic Respiratory Disease Death Rate Over Time (2000-2023) - Selected Countries
```
...
Chronic Respiratory Disease Gender Gap Over Time (2000-2023) - All OECD Countries
```
...
Chronic Respiratory Disease Gender Gap Over Time (2000-2023) - Selected Countries
```
...
Suicide Death Rate Over Time (2000-2023) - All OECD Countries
```
...
Suicide Death Rate Over Time (2000-2023) - Selected Countries
```
...
Suicide Gender Gap Over Time (2000-2023) - All OECD Countries
```
...
Suicide Gender Gap Over Time (2000-2023) - Selected Countries
```
...
Homicide Death Rate Over Time (2000-2023) - All OECD Countries
```
...
Homicide Death Rate Over Time (2000-2023) - Selected Countries
```
...
Homicide Gender Gap Over Time (2000-2023) - All OECD Countries
```
...
Homicide Gender Gap Over Time (2000-2023) - Selected Countries
```
...
Road Traffic Injury Death Rate Over Time (2000-2023) - All OECD Countries
```
...
Road Traffic Injury Death Rate Over Time (2000-2023) - Selected Countries
```
...
Road Traffic Injury Gender Gap Over Time (2000-2023) - All OECD Countries
```
...
Road Traffic Injury Gender Gap Over Time (2000-2023) - Selected Countries
```
...
Liver Disease Death Rate Over Time (2000-2023) - All OECD Countries
```
...
Liver Disease Death Rate Over Time (2000-2023) - Selected Countries
```
...
Liver Disease Gender Gap Over Time (2000-2023) - All OECD Countries
```
...
Liver Disease Gender Gap Over Time (2000-2023) - Selected Countries
```
...
Cancer Death Rate Over Time (2000-2023) - All OECD Countries
```
...
Cancer Death Rate Over Time (2000-2023) - Selected Countries
```
...
Cancer Gender Gap Over Time (2000-2023) - All OECD Countries
```
...
Cancer Gender Gap Over Time (2000-2023) - Selected Countries
```
...
Unintentional Injury Death Rate Over Time (2000-2023) - All OECD Countries
```
...
Unintentional Injury Death Rate Over Time (2000-2023) - Selected Countries
```
...
Unintentional Injury Gender Gap Over Time (2000-2023) - All OECD Countries
```
...
Unintentional Injury Gender Gap Over Time (2000-2023) - Selected Countries
```
...
Diabetes Death Rate Over Time (2000-2023) - All OECD Countries
```
...
Diabetes Death Rate Over Time (2000-2023) - Selected Countries
```
...
Diabetes Gender Gap Over Time (2000-2023) - All OECD Countries
```
...
- All analyses use data from 2000-2023, including the COVID-19 period (2020-2023)
- **HALE data source**: IHME Global Burden of Disease 2023
- **Life Expectancy data source**: Our World in Data (OWID), combining Human Mortality Database and UN World Population Prospects
- **Cause-specific mortality indicators**: IHME Global Burden of Disease
