...
write_html_table(model_comparison_sorted, f'tables/model_comparison_hale_{cutoff_year}.html')
```
...
write_html_table(coef_comparison_nonzero, f'tables/coefficient_comparison_hale_{cutoff_year}.html')
```
...
write_html_table(feature_selection_summary, f'tables/feature_selection_summary_hale_{cutoff_year}.html')
```
...
plt.savefig(f'figs/residuals_vs_predicted_hale_{cutoff_year}.png', dpi=300, bbox_inches='tight')
```
...
plt.savefig(f'figs/residuals_distribution_hale_{cutoff_year}.png', dpi=300, bbox_inches='tight')
```
...
write_html_table(residuals_by_country, f'tables/residuals_by_country_hale_{cutoff_year}.html')
```
...
plt.tight_layout()
plt.savefig(f'figs/residuals_vs_predictors_hale_{cutoff_year}.png', dpi=300, bbox_inches='tight')
```
...
write_html_table(importance_nonzero, f'tables/predictor_importance_hale_{cutoff_year}.html')
importance_nonzero
```
...
plt.savefig(f'figs/predictor_importance_hale_{cutoff_year}.png', dpi=300, bbox_inches='tight')
```
...
write_html_table(indicator_importance_formatted, f'tables/indicator_importance_hale_{cutoff_year}.html')
...
plt.savefig(f'figs/indicator_importance_hale_{cutoff_year}.png', dpi=300, bbox_inches='tight')
```
...
write_html_table(coef_comparison_selected, f'tables/elasticnet_ols_coefficient_comparison_hale_{cutoff_year}.html')
```
...
elastic_net_coefs_all.to_csv(f'../data/elasticnet_coefficients_hale_{cutoff_year}.csv', index=False)
print(f"Saved Elastic Net coefficients to: data/elasticnet_coefficients_hale_{cutoff_year}.csv")
```

```python
# Save selected coefficients comparison (Elastic Net vs OLS) to CSV
coef_comparison_selected.to_csv(f'../data/coefficient_comparison_hale_{cutoff_year}.csv', index=False)
print(f"Saved coefficient comparison to: data/coefficient_comparison_hale_{cutoff_year}.csv")
```
...
write_html_table(performance_comparison, f'tables/performance_comparison_hale_{cutoff_year}.html')
```
...
write_html_table(predictions_comparison, f'tables/predictions_comparison_hale_{cutoff_year}.html')
```
...
plt.tight_layout()
plt.savefig(f'figs/predictions_comparison_hale_{cutoff_year}.png', dpi=300, bbox_inches='tight')
```
...
write_html_table(usa_counterfactuals, f'tables/counterfactuals_usa_hale_{cutoff_year}.html')
```
